...
function renderKPIs(totals) {
  const cards = [
    { label: "Total Items", value: totals.items, accent: "var(--teal)" },
    { label: "Completed", value: totals.complete, accent: "var(--green)" },
    { label: "In Progress", value: totals.inProgress, accent: "#50c5d1" },
    { label: "Not Started", value: totals.notStarted, accent: "var(--ink-faint)" },
    { label: "Start Delayed", value: totals.startDelayed, accent: "var(--magenta)" },
    { label: "Completion Overdue", value: totals.completionOverdue, accent: "var(--orange)" },
  ];
